...
${frame.code}`;
    ...
    "6XVkV": [
      function (require, module, exports) {
        ...
        var _simplelightboxDefault =
          parcelHelpers.interopDefault(_simplelightbox);
      ...
      {
        "./gallery-items": "9C7dK",
        simplelightbox: "9ydBq",
        "simplelightbox/dist/simple-lightbox.min.css": "kaxSc",
          ...
          _createClass(SimpleLightbox, [
            ...
            },
            {
              ...
              value: function adjustImage(direction) {
                ...
                tmpImage.addEventListener("error", function (event) {
                  ...
                  ].dispatchEvent(new Event("error." + _this5.eventNamespace));
                ...
                tmpImage.addEventListener("load", function (event) {
                  ...
                  } else if (_this5.relatedElements.length === 1)
                    _this5.hide(
                    ...
                    if (event.type === "touchmove") {
                      ...
                      if (_this6.controlCoordinates.touchCount > 1) {
                        ...
                        if (
                          ...
                          /* Initialize helpers */ _this6.controlCoordinates.targetScale =
                            _this6.minMax(
                              (_this6.controlCoordinates.targetPinchDistance /
                                _this6.controlCoordinates
            ...
            },
            {
              ...
              value: function updateHash() {
                ...
                else if (this.historyHasChanges)
